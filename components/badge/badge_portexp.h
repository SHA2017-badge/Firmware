 ...
 */
extern esp_err_t badge_portexp_init(void);

/** configure port-expander gpio port - io direction */
extern esp_err_t badge_portexp_set_io_direction(uint8_t pin, uint8_t direction);
/** configure port-expander gpio port - output state */
extern esp_err_t badge_portexp_set_output_state(uint8_t pin, uint8_t state);
/** configure port-expander gpio port - output high-z */
extern esp_err_t badge_portexp_set_output_high_z(uint8_t pin, uint8_t high_z);
/** configure port-expander gpio port - input default state */
extern esp_err_t badge_portexp_set_input_default_state(uint8_t pin, uint8_t state);
/** configure port-expander gpio port - pull enable */
extern esp_err_t badge_portexp_set_pull_enable(uint8_t pin, uint8_t enable);
/** configure port-expander gpio port - pull down/up */
extern esp_err_t badge_portexp_set_pull_down_up(uint8_t pin, uint8_t up);
/** configure port-expander gpio port - interrupt enable/disable */
extern esp_err_t badge_portexp_set_interrupt_enable(uint8_t pin, uint8_t enable);
